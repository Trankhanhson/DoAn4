...
@endsection
@section('content')
<main id="main" class="main" ng-app="OrderApp" ng-controller="OrderController" data-statusId="4">
    <h4 class="fw-bold">Danh sách đơn hàng đã hủy</h4>
                        ...
                        <table class="table table-hover table-bordered pt-4" id="dataTable">
                            ...
                            <tbody class="category-wrap">
                                <tr dir-paginate="o in OrderList | itemsPerPage: pageSize" total-items="totalCount">
                                    ...
                                    <td>
                                        <a class=" btn-tool bg-primary" ng-click="showDetail($index,o.OrdID)" data-bs-toggle="modal" data-bs-target="#SeeDtail"><i class="fa-solid fa-eye"></i></a>
                                        <a class="btn-delete btn-tool" title="Xóa" ng-click="Delete($index,o)"><i class="fa-solid fa-trash" style="pointer-events:none;"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
