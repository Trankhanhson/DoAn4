...
@section('scripts')
    ...
    <script src="/assets/admin/FileAngularjs/Discount/CreateDiscountAngular.js"></script>
@endsection
@section('styles')
    <link href="/assets/admin/css/DiscountProduct.css" rel="stylesheet" />
@endsection
@section('content')
    <main id="main" class="main" ng-app="discountApp" ng-controller="discountController" ng-init="checkProduct = false">
        <h4 class="fw-bold">Thêm chương trình khuyến mại</h4>
