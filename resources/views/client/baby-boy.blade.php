...
<main>
    ...
    <div class="container-main">
        ...
        <section class="banner pb-4">
            <img src="https://media.canifa.com/Simiconnector/banner_name_tablet1683129438.webp" width="100%" alt="">
        </section>
...
<div class="offcanvas offcanvas-start" id="sidebar">
    ...
    <div class="offcanvas-body">
        <ul class="mb-3">
            ...
            <li class="header-item">
                <a class="header-link active" href="{{ route('client.baby_boy') }}">BÉ TRAI</a>
            </li>
            <li class="header-item">
