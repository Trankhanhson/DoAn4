        ...
        for (let j = 0; j < listColorLength; j++) {
            ...
            for (let i = 0; i < listSizeLength; i++) {
                str += `<tr>
                            ...
                            <td>
                            <div class="input-wrap d-flex">
                                <input type="number" value="0"  class="input-create input-minimumQuantity text-dark" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : 0">
                            </div>
                            </td >
