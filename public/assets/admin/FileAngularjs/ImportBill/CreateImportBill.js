    ...
    $scope.selectProduct = function (p) {
        ...
        if (listElement.length > 0) {
            ...
            listElement.each((index, value) => {
                ...
                for (let i = 0; i < p.product_variations.length; i++) {
                    if (p.product_variations[i].ProVariationID == variationSelected) {
                        let detail = {
                            ProId: p.ProId,
                            ProVariationID: p.product_variations[i].ProVariationID,
                            DisplayImage: p.product_variations[i].DisplayImage,
                            NameSize: p.product_variations[i].product_size.NameSize,
                            NameColor: p.product_variations[i].product_color.NameColor,
                            Quantity: 1,
                            SubTotal: p.Price
                        }
